...
export const knowledgeBaseApi = {
  ...
  update: (id: string, data: Partial<CreateKnowledgeBaseRequest> & { hardware_tier?: string; rag_plan?: string; reindex_required?: boolean; splitter_config?: Record<string, any>; retrieval_config?: Record<string, any>; datastore?: Record<string, any> }) => api.put(`/knowledge-bases/${id}`, data),
  testDatastore: (data: { type: string; dsn?: string }) => api.post('/knowledge-bases/test-datastore', data),
